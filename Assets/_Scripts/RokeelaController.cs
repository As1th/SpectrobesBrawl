...
public class RokeelaController : MonoBehaviour
{
    ...
    public void spawnSmashParticle()
    {
        Instantiate(smashParticle, new Vector3(weapon.transform.position.x, weapon.transform.position.y-6f, weapon.transform.position.z), Quaternion.Euler(-90,0,0));
    }
    ...
    {
        weapon.GetComponent<RokeelaDamage>().hitOnce = false;
        deactivateHurtBox();
        attackCoolDown = 10;
        //attackCoolDown = 30;
        animator.SetTrigger("Idle");
