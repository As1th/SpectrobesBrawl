...
public class MoldovaController : MonoBehaviour
{
    ...
    public void activateHurtBox()
    {
        ...
        Instantiate(effectParticle, weapon.transform.position, Quaternion.identity);
    }
    ...
    {
        weapon.GetComponent<MoldovaDamage>().hitOnce = false;
        deactivateHurtBox();
        attackCoolDown = 10;
        //attackCoolDown = 30;
        animator.SetTrigger("Idle");
